[SciChart.js Documentation - v0.0.6](../README.md) › [Globals](../globals.md) › [LegendModifier](legendmodifier.md)

# Class: LegendModifier

The LegendModifier provides interactive legend behavior on a 2D [SciChartSurface](scichartsurface.md)
within SciChart - High Performance [JavaScript Charts](https://www.scichart.com/javascript-chart-features)

**`remarks`** 

To apply the LegendModifier to a [SciChartSurface](scichartsurface.md) and add tooltip behavior,
...
* [constructor](legendmodifier.md#constructor)

### Properties

* [invalidateParentCallback](legendmodifier.md#invalidateparentcallback)
* [modifierGroup](legendmodifier.md#modifiergroup)
* [sciChartLegend](legendmodifier.md#scichartlegend)
* [xyDirection](legendmodifier.md#xydirection)

### Accessors

* [canReceiveMouseEvents](legendmodifier.md#canreceivemouseevents)
* [isAttached](legendmodifier.md#isattached)
* [isEnabled](legendmodifier.md#isenabled)
* [modifierType](legendmodifier.md#modifiertype)
* [parentSurface](legendmodifier.md#parentsurface)
* [receiveHandledEvents](legendmodifier.md#receivehandledevents)

### Methods

* [applyTheme](legendmodifier.md#applytheme)
* [modifierDoubleClick](legendmodifier.md#modifierdoubleclick)
* [modifierMouseDown](legendmodifier.md#modifiermousedown)
* [modifierMouseEnter](legendmodifier.md#modifiermouseenter)
* [modifierMouseLeave](legendmodifier.md#modifiermouseleave)
* [modifierMouseMove](legendmodifier.md#modifiermousemove)
* [modifierMouseUp](legendmodifier.md#modifiermouseup)
* [modifierMouseWheel](legendmodifier.md#modifiermousewheel)
* [onAttach](legendmodifier.md#onattach)
* [onAttachSeries](legendmodifier.md#onattachseries)
* [onDetach](legendmodifier.md#ondetach)
* [onDetachSeries](legendmodifier.md#ondetachseries)
* [onParentSurfaceRendered](legendmodifier.md#onparentsurfacerendered)
* [setParentSurface](legendmodifier.md#setparentsurface)

## Constructors

###  constructor

\+ **new LegendModifier**(`options?`: [ILegendModifierOptions](../interfaces/ilegendmodifieroptions.md)): *[LegendModifier](legendmodifier.md)*

*Overrides [ChartModifierBase2D](chartmodifierbase2d.md).[constructor](chartmodifierbase2d.md#constructor)*

*Defined in [src/Charting/ChartModifiers/LegendModifier.ts:54](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/ChartModifiers/LegendModifier.ts#L54)*
...
------ | ------ | ------ |
`options?` | [ILegendModifierOptions](../interfaces/ilegendmodifieroptions.md) | Optional parameters [ILegendModifierOptions](../interfaces/ilegendmodifieroptions.md) used to configure the modifier  |

**Returns:** *[LegendModifier](legendmodifier.md)*
...
*Defined in [src/Charting/ChartModifiers/LegendModifier.ts:73](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/ChartModifiers/LegendModifier.ts#L73)*
...
*Defined in [src/Charting/ChartModifiers/LegendModifier.ts:101](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/ChartModifiers/LegendModifier.ts#L101)*
...
*Defined in [src/Charting/ChartModifiers/LegendModifier.ts:80](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/ChartModifiers/LegendModifier.ts#L80)*
...
*Defined in [src/Charting/ChartModifiers/LegendModifier.ts:87](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/ChartModifiers/LegendModifier.ts#L87)*
...
*Defined in [src/Charting/ChartModifiers/LegendModifier.ts:93](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/ChartModifiers/LegendModifier.ts#L93)*
