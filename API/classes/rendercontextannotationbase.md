[SciChart JS API - v0.0.6](../README.md) › [Globals](../globals.md) › [RenderContextAnnotationBase](rendercontextannotationbase.md)

# Class: RenderContextAnnotationBase

The Base class for an [Annotation](annotationbase.md) which draws using SciChart's built-in WebGL2
WebAssembly {@link WebGL2RenderingContext | RenderContext}, enabling fast drawing at expense of
having lots of customisation like the [SvgAnnotationBase](svgannotationbase.md) provides.

## Hierarchy

* [AnnotationBase](annotationbase.md)

  ↳ **RenderContextAnnotationBase**

  ↳ [LineAnnotation](lineannotation.md)

  ↳ [BoxAnnotation](boxannotation.md)
...
* [invalidateParentCallback](rendercontextannotationbase.md#invalidateparentcallback)
* [type](rendercontextannotationbase.md#readonly-type)

### Accessors

* [annotationLayer](rendercontextannotationbase.md#annotationlayer)
* [isEditable](rendercontextannotationbase.md#iseditable)
* [isHidden](rendercontextannotationbase.md#ishidden)
* [parentSurface](rendercontextannotationbase.md#parentsurface)
* [x1](rendercontextannotationbase.md#x1)
* [x2](rendercontextannotationbase.md#x2)
* [xAxisId](rendercontextannotationbase.md#xaxisid)
* [xCoordinateMode](rendercontextannotationbase.md#xcoordinatemode)
* [y1](rendercontextannotationbase.md#y1)
* [y2](rendercontextannotationbase.md#y2)
* [yAxisId](rendercontextannotationbase.md#yaxisid)
* [yCoordinateMode](rendercontextannotationbase.md#ycoordinatemode)

### Methods

* [delete](rendercontextannotationbase.md#abstract-delete)
* [drawWithContext](rendercontextannotationbase.md#abstract-drawwithcontext)
* [onAttach](rendercontextannotationbase.md#onattach)
* [onDetach](rendercontextannotationbase.md#ondetach)
...
*Defined in [src/Charting/Visuals/Annotations/RenderContextAnnotationBase.ts:14](https://github.com/ABTSoftware/SciChart.Dev/blob/f6fba97af2/Web/src/SciChart/src/Charting/Visuals/Annotations/RenderContextAnnotationBase.ts#L14)*
...
*Defined in [src/Charting/Visuals/Annotations/AnnotationBase.ts:315](https://github.com/ABTSoftware/SciChart.Dev/blob/f6fba97af2/Web/src/SciChart/src/Charting/Visuals/Annotations/AnnotationBase.ts#L315)*
...
*Defined in [src/Charting/Visuals/Annotations/RenderContextAnnotationBase.ts:31](https://github.com/ABTSoftware/SciChart.Dev/blob/f6fba97af2/Web/src/SciChart/src/Charting/Visuals/Annotations/RenderContextAnnotationBase.ts#L31)*
...
`xCalc` | [CoordinateCalculatorBase](coordinatecalculatorbase.md) | the X Axis Coordinate Calculator for the current draw operation |
`yCalc` | [CoordinateCalculatorBase](coordinatecalculatorbase.md) | the Y Axis Coordinate Calculator for the current draw operation |
...
*Defined in [src/Charting/Visuals/Annotations/AnnotationBase.ts:307](https://github.com/ABTSoftware/SciChart.Dev/blob/f6fba97af2/Web/src/SciChart/src/Charting/Visuals/Annotations/AnnotationBase.ts#L307)*
...
*Defined in [src/Charting/Visuals/Annotations/AnnotationBase.ts:311](https://github.com/ABTSoftware/SciChart.Dev/blob/f6fba97af2/Web/src/SciChart/src/Charting/Visuals/Annotations/AnnotationBase.ts#L311)*
