[SciChart.js Documentation - v0.0.6](../README.md) › [Globals](../globals.md) › [SpritePointMarker](spritepointmarker.md)
...
* [constructor](spritepointmarker.md#constructor)

### Properties

* [invalidateParentCallback](spritepointmarker.md#invalidateparentcallback)

### Accessors

* [fill](spritepointmarker.md#fill)
* [height](spritepointmarker.md#height)
* [image](spritepointmarker.md#image)
* [stroke](spritepointmarker.md#stroke)
* [strokeThickness](spritepointmarker.md#strokethickness)
* [width](spritepointmarker.md#width)

### Methods

* [createCanvasTexture](spritepointmarker.md#createcanvastexture)
* [delete](spritepointmarker.md#delete)
* [drawSprite](spritepointmarker.md#drawsprite)
* [getSprite](spritepointmarker.md#getsprite)

## Constructors

###  constructor

\+ **new SpritePointMarker**(`webAssemblyContext`: TSciChart, `options?`: [ISpritePointMarkerOptions](../interfaces/ispritepointmarkeroptions.md)): *[SpritePointMarker](spritepointmarker.md)*

*Overrides [BasePointMarker](basepointmarker.md).[constructor](basepointmarker.md#constructor)*

*Defined in [src/Charting/Visuals/PointMarkers/SpritePointMarker.ts:10](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/Visuals/PointMarkers/SpritePointMarker.ts#L10)*
...
`options?` | [ISpritePointMarkerOptions](../interfaces/ispritepointmarkeroptions.md) |

**Returns:** *[SpritePointMarker](spritepointmarker.md)*
...
*Defined in [src/Charting/Visuals/PointMarkers/SpritePointMarker.ts:17](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/Visuals/PointMarkers/SpritePointMarker.ts#L17)*

**Returns:** *HTMLImageElement*

• **set image**(`image`: HTMLImageElement): *void*

*Defined in [src/Charting/Visuals/PointMarkers/SpritePointMarker.ts:20](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/Visuals/PointMarkers/SpritePointMarker.ts#L20)*
...
*Defined in [src/Charting/Visuals/PointMarkers/SpritePointMarker.ts:29](https://github.com/ABTSoftware/SciChart.Dev/blob/46671d21ce/Web/src/SciChart/src/Charting/Visuals/PointMarkers/SpritePointMarker.ts#L29)*
