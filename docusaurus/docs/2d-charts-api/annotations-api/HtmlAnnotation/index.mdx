...
We refer to HTML and SVG Annotations as "DOM Annotations" since they share some similar logic and the same rendering principles. Thus, the common base class is [DomAnnotation](https://www.scichart.com/documentation/js/v4/typedoc/classes/domannotationbase.html).

:::info
There are [isDomAnnotation](https://www.scichart.com/documentation/js/v4/typedoc/classes/annotationbase.html#isdomannotation) and [isSvgAnnotation](https://www.scichart.com/documentation/js/current/typedoc/classes/annotationbase.html#issvgannotation) properties on an annotation.
:::
...
And exposes a reference to this element via [CustomHtmlAnnotation.htmlElement](https://www.scichart.com/documentation/js/v4/typedoc/classes/customhtmlannotation.html#htmlelement).
...
```ts file=./demo.js start=region_B_start end=region_B_end
