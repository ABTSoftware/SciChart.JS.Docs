import ChartContainer from "@site/src/components/ChartContainer"
import demoJsContent from "!!raw-loader!./demo.js"
import demoCssContent from "!!raw-loader!./demo.css"
...
**Live Example**:
<ChartContainer demoJsContent={demoJsContent} cssContent={demoCssContent} />
