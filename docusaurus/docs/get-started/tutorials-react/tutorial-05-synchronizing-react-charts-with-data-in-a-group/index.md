...
Also, for the project setup with webpack and npm, check out [Tutorial 01 - Understanding the scichart-react boilerplate](TutorialSetupProjectWithSciChartReact.html "Tutorial 01 - Understanding the scichart-react boilerplate Documentation Page") which explains how to start from scratch!

Refactoring the App.jsx Code
----------------------------

Starting with the App.jsx code from [Tutorial 04](../tutorial-04-adding-and-removing-charts-to-a-group-in-react/ "Tutorial 04 Documentation Page"), let's begin by refactoring the code. We want to extract the chart initialization into a separate code file, as well as create a data manager to provide data to the chart on initialization.
...
<CodeSnippetBlock labels={["App.tsx","initChart.ts"]}>
```tsx
import React, { useState, useRef } from "react";
import "./styles.css";
import { SciChartGroup, SciChartReact } from "scichart-react";
...
![](/images/scichart-react-sync-charts.gif)
