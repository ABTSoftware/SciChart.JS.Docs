import { NumberRange, EColumnMode, EColumnYMode, SciChartSurface, NumericAxis, SciChartJsNavyTheme, FastRectangleRenderableSeries, XyxyDataSeries, ZoomExtentsModifier, ZoomPanModifier, MouseWheelZoomModifier, TextAnnotation, EHorizontalAnchorPoint, EVerticalAnchorPoint, ECoordinateMode, SeriesSelectionModifier, DpiHelper } from "scichart";
                ...
                sciChartSurface.domCanvas2D.addEventListener("mousemove", mouseEvent => {
                    ...
                    hoveredSeries.forEach(series => {
                        ...
                        if (hitTestInfo.isHit) {
                            ...
                            console.log("- Values:", hitTestInfo.xValue, hitTestInfo.yValue, hitTestInfo.x1Value, hitTestInfo.y1Value);
