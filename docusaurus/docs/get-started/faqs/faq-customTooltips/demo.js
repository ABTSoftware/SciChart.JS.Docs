import { SciChartSurface, NumericAxis, XyDataSeries, StackedColumnRenderableSeries, RolloverModifier, NumberRange, StackedColumnCollection, SciChartJsNavyTheme } from "scichart";
// #region_A_start
...
const customTooltipTemplate = (id, seriesInfo, rolloverTooltip) => {
...
async function drawExample(rootElement) {
    ...
    blueSeries.rolloverModifierProps.tooltipTemplate = (id, seriesInfo, rolloverTooltip) => {
    ...
    mintSeries.rolloverModifierProps.tooltipTemplate = (id, seriesInfo, rolloverTooltip) => {
        return customTooltipTemplate(id, seriesInfo, rolloverTooltip);
    };
