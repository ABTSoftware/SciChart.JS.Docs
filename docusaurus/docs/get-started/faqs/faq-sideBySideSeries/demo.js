import { NumericAxis, SciChartSurface, HlcDataSeries, MouseWheelZoomModifier, ZoomExtentsModifier, ZoomPanModifier, NumberRange, FastErrorBarsRenderableSeries, FastCandlestickRenderableSeries, OhlcDataSeries, LegendModifier, FastImpulseRenderableSeries, XyDataSeries } from "scichart";
// #region_A_start
/**
 ...
 * @returns
 */
function calculateShift(initialVal, index, totalCount, spacing = 0.02) {
...
const drawExample = async (rootElement) => {
    ...
    sciChartSurface.chartModifiers.add(new ZoomExtentsModifier(), new ZoomPanModifier(), new MouseWheelZoomModifier(), new LegendModifier());
