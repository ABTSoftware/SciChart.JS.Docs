...
From [Tutorial 03 - Adding Zooming, Panning Behavior](/get-started/tutorials-js-npm-webpack/tutorial-03-adding-zooming-panning-behavior/), we learned that we can add ChartModifiers to the [sciChartSurface.chartModifiers:blue_book:](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartsurface.html#chartmodifiers) collection to add specific zoom, or pan behaviors to the chart.
...
If we want to enable user-zoom, and also scroll the chart, we need to selectively implement that scroll. To do so we can use the [sciChartSurface.zoomState:blue_book:](https://www.scichart.com/documentation/js/v5/typedoc/classes/scichartsurface.html#zoomstate) property.
