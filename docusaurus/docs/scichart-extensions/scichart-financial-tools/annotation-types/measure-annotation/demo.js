...
async function drawExample(divElementId) {
    ...
    const { MeasureAnnotation, SciTraderLightTheme } = SciChartFinancialTools; // if using npm, import from "scichart-financial-tools";
    ...
    sciChartSurface.annotations.add(new MeasureAnnotation({
