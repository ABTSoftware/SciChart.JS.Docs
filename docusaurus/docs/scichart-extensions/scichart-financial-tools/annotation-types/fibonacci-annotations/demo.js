...
async function drawExample(divElementId) {
    ...
    const { EFibonacciLabelColorMode, EFibonacciLabelPlacement, FibonacciRetracementAnnotation, FibonacciSpeedResistanceArcsAnnotation, SciTraderLightTheme } = SciChartFinancialTools; // if using npm, import from "scichart-financial-tools";
