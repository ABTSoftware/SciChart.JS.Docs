...
async function drawExample(divElementId) {
    ...
    const { EFibonacciLabelColorMode, EFibonacciLabelPlacement, FibonacciWedgeAnnotation, SciTraderLightTheme } = SciChartFinancialTools; // if using npm, import from "scichart-financial-tools";
    ...
    sciChartSurface.annotations.add(new FibonacciWedgeAnnotation({
