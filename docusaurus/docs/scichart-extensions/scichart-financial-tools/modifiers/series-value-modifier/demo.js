...
async function drawExample(divElementId) {
    // #region_A_start
    const { CategoryAxis, FastCandlestickRenderableSeries, FastLineRenderableSeries, MouseWheelZoomModifier, NumberRange, NumericAxis, OhlcDataSeries, SciChartJsNavyTheme, SciChartSurface, XyDataSeries, ZoomExtentsModifier, ZoomPanModifier } = SciChart; // or import from "scichart"
    ...
    sciChartSurface.chartModifiers.add(new MouseWheelZoomModifier(), new ZoomPanModifier(), new ZoomExtentsModifier(), new SeriesValueModifier({
