...
async function drawExample(divElementId) {
    ...
    const { EAnnotationVisibilityMode, EMultiPointLabelAnchorMode, EAxisLabelDrawMode, PolyLineAnnotation, SciTraderLightTheme, } = SciChartFinancialTools; // if using npm, import from "scichart-financial-tools";
