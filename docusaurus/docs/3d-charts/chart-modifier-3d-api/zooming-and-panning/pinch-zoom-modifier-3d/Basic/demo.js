import { SciChart3DSurface, NumericAxis3D, Vector3, SciChartJsNavyTheme, OrbitModifier3D, PinchZoomModifier3D, MouseWheelZoomModifier3D, ResetCamera3DModifier } from "scichart";
async function pinchZoom3D(divElementId) {
    ...
    sciChart3DSurface.chartModifiers.add(new PinchZoomModifier3D(), new OrbitModifier3D(), new MouseWheelZoomModifier3D(), new ResetCamera3DModifier());
    // #region_A_end
}
pinchZoom3D("scichart-root");
