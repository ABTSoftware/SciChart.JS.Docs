import { SciChart3DSurface, NumericAxis3D, Vector3, NumberRange, SciChartJsNavyTheme, ENumericFormat, MouseWheelZoomModifier3D, OrbitModifier3D, ResetCamera3DModifier } from "scichart";
async function numericAxisFormattedAsDates3D(divElementId) {
    ...
    // region_A_start
    // Register font
    await sciChart3DSurface.registerFont("braahone", "https://raw.githubusercontent.com/google/fonts/main/ofl/braahone/BraahOne-Regular.ttf");
    ...
    sciChart3DSurface.chartModifiers.add(new MouseWheelZoomModifier3D(), // provides camera zoom on mouse wheel
