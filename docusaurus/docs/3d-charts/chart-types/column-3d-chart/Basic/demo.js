import { SciChart3DSurface, NumericAxis3D, Vector3, SciChartJsNavyTheme, ColumnRenderableSeries3D, CubePointMarker3D, MouseWheelZoomModifier3D, OrbitModifier3D, ResetCamera3DModifier, XyzDataSeries3D } from "scichart";
...
async function columnRenderableSeries3D(divElementId) {
    ...
    sciChart3DSurface.renderableSeries.add(new ColumnRenderableSeries3D(wasmContext, {
        dataSeries,
        fill: "#F48420",
        dataPointWidthX: 0.5,
        dataPointWidthZ: 0.5,
