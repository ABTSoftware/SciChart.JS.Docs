import { EMainLightMode, MouseWheelZoomModifier3D, NumericAxis3D, NumberRange, OrbitModifier3D, ResetCamera3DModifier, SciChart3DSurface, SciChartJsNavyTheme, Vector3 } from "scichart";
import { AuroraRibbonSceneEntity } from "./AuroraRibbonSceneEntity";
async function immediateMesh3D(divElementId) {
