...
- **2D Charts API**
  ...
  - **Annotations API**
    ...
    - [⚠️ CustomAnnotation](/docs/2d-charts/annotations-api/custom-annotation)
  ...
  - **ChartModifier API**
    ...
    - **VerticalSliceModifier**
      ...
      - [Customizing VerticalSliceModifier Tooltip Containers](/docs/2d-charts/chart-modifier-api/vertical-slice-modifier/customizing-vertica-slice-tooltip-container)
    ...
    - [RolloverModifier (VerticalLine + Tooltips)](/docs/2d-charts/chart-modifier-api/rollover-modifier)
  - **Subcharts API**
