---
sidebar_position: 9
title: "Misc licensing faqs"
---

# SciChart.js Miscellaneous Licensing FAQs

This page has further information about licensing SciChart.js, the licensing model, the different types of license
...
```mermaid
flowchart TD
    A(Choosing a SciChart.js License) --> B
    B{Is the domain at runtime 'localhost' or unknown?}
    B -->|Yes e.g. app served at localhost or unknown| C[Advanced License required: Bundle Products]
    B -->|No e.g. app served at mydomain.com| D[Standard License: SciChart.js Products]
```
