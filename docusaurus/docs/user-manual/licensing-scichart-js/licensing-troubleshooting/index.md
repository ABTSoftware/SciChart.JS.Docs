...
:::info
If you have purchased commerical licenses of SciChart.js and cannot manage to get your application working with the license applied,
please check out our licensing troubleshooting steps below
:::
...
![SciChart.js License Troubleshooting enable License Debug](/images/licensingtroubleshooting_license_debug.png)

4. Reload the page
5. SciChart license debug info will be dumped to the console:

![SciChart.js License Troubleshooting License Debug Output](/images/licensingtroubleshooting_license_debug_output.png)
...
If any errors or warnings are found in the `LICENSE_DEBUG` output, this can guide you to what the problem is and how to solve it. Pass this license debug output to [tech support](https://www.scichart.com/contact-us/#tech-support) so we can assist.
:::info
...
If you require further urgent assistance with SciChart.js licensing, [contact tech support](https://www.scichart.com/contact-us/#tech-support) sending us the following info:
