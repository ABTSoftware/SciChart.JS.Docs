...
# Activating a Purchased Developer License

:::info
To allow `localhost` Development of SciChart.js applications without a watermark and to comply with the [terms for commercial use](https://www.scichart.com/scichart-eula),
you will need to activate a purchased developer license on your machine where you develop your application(s).
...
1. Download and install the [cross platform licensing wizard](https://www.scichart.com/cross-platform-licensing-wizard/) application.
2. Once installed, log in with a scichart account (create an account at [scichart.com/register](https://www.scichart.com/register/))
3. Select the tab "Activation" in the licensing wizard app

![Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_activate1.png)

4. Enter your license serial key and click "Activate"

![Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_activate2.png)
...
![Offline Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_offlineactivate1.png)

2. Select the "Offline Licensing" tab in the licensing wizard

![Offline Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_offlineactivate2.png)

3. Enter the developer serial key you are trying to activate. Click "Next"

![Offline Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_offlineactivate3.png)

4. This will generate a request code.
5. Send this request code by email by clicking "Next"

![Offline Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_offlineactivate4.png)

6. Copy the request code and email it to
   sales_processing@abtsoftware.co.uk with the subject line **ACTIVATION REQUEST**
7. You will be emailed a response code within 5 minutes.
8. Once received, paste this response code into the licensing wizard to continue and complete the developer license activation.

![Offline Activating a scichart.js license using the licensing wizard](/images/licensingtroubleshooting_offlineactivate5.png)

:::info
Note: The request code must be requested on the PC you will be developing on.
The response code is machine-specific. When received in your email (another PC) - copy and paste the response code into the box above to proceed with the activation
:::
