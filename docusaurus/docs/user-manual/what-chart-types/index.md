...
built-in methods of customising rendering be insufficient. These are accessible via properties on the `SciChartSurface` such as [domSvgContainer:blue_book:](/typedoc/classes/scichartsurface.html#domsvgcontainer).
