...
// #region_A_start
const { NativeTextAnnotation, PolarNumericAxis, SciChartPolarSurface, SciChartJsNavyTheme, EPolarAxisMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, ECoordinateMode, EAnnotationLayer } = SciChart;
...
async function builderExample(divElementId) {
    // #region_B_start
    const { build2DChart, build2DPolarChart, EAnnotationType, EHorizontalAnchorPoint, EVerticalAnchorPoint, ECoordinateMode, EAnnotationLayer } = SciChart;
