...
async function drawExample(divElementId) {
    ...
    // #region_A_end
    const { MouseWheelZoomModifier, ZoomExtentsModifier, ZoomPanModifier, NativeTextAnnotation, EHorizontalAnchorPoint, EVerticalAnchorPoint, ECoordinateMode, NumberRange } = SciChart;
