...
async function drawExample(divElementId) {
    const { SciChartSurface, NumericAxis, EVerticalTextPosition, AnnotationHoverModifier, ECursorStyle } = SciChart; // or import from "scichart"
    const { EAnnotationVisibilityMode, EMultiPointLabelAnchorMode, ExtendedLineAnnotation, SciTraderLightTheme } = SciChartFinancialTools; // if using npm, import from "scichart-financial-tools";
