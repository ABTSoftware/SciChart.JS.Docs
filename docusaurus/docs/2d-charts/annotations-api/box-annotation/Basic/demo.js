...
// #region_A_start
const { BoxAnnotation, TextAnnotation, NumericAxis, SciChartSurface, NumberRange, SciChartJsNavyTheme } = SciChart;
...
async function addAnnotationToChart(divElementId) {
    ...
    sciChartSurface.annotations.add(new TextAnnotation({ fontSize: 12, text: "Draw Boxes", x1: 3.3, y1: 6.3 }), new BoxAnnotation({
        fill: "#279B2755",
        stroke: "#279B27",
        strokeThickness: 1,
        x1: 3.5,
