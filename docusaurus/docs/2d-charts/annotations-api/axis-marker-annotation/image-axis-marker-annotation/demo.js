...
// #region_A_start
const { AxisMarkerAnnotation, NumericAxis, SciChartSurface, SciChartJsNavyTheme, createImageAsync, TextAnnotation, EHorizontalAnchorPoint } = SciChart;
...
async function addAnnotationToChart(divElementId) {
    ...
    sciChartSurface.annotations.add(new AxisMarkerAnnotation({
        y1: 5.1,
        isEditable: true,
