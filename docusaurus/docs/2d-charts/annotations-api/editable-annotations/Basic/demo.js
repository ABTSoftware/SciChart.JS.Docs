...
const { TextAnnotation, NumericAxis, SciChartSurface, SciChartJsNavyTheme, ECoordinateMode, EHorizontalAnchorPoint } = SciChart;
...
async function addAnnotationToChart(divElementId) {
    ...
    addChartTitle(sciChartSurface, "Editable Text Annotations", "Drag the text annotation to see the value update");
}
