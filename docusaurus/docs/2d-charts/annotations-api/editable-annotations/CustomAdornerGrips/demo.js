...
const { AxisMarkerAnnotation, NumericAxis, SciChartSurface, SciChartJsNavyTheme, AnnotationDragDeltaEventArgs, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, Point } = SciChart;
...
async function addAnnotationToChart(divElementId) {
    ...
    sciChartSurface.annotations.add(new DiscreteAxisMarker({
        isEditable: true,
        y1: 5,
    ...
    addChartTitle(sciChartSurface, "Discrete Draggable Annotations", "Drag the axis marker annotation to see the value update");
}
