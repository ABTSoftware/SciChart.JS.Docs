...
const { BoxAnnotation, TextAnnotation, EXyDirection, ECoordinateMode, EHorizontalAnchorPoint, NumericAxis, SciChartSurface, SciChartJsNavyTheme } = SciChart;
...
async function addAnnotationToChart(divElementId) {
    ...
    addChartTitle(sciChartSurface, "Restricting Resize Direction", "Resize the Box in the X-Direction only");
}
