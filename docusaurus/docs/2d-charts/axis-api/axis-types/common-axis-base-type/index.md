...
All the axis types in SciChart inherit from [AxisCore:blue_book:](https://www.scichart.com/documentation/js/v4/typedoc/classes/axiscore.html) - a common type shared across both 2D and 3D Charts - and all 2D Axis inherit **[AxisBase2D:blue_book:](https://www.scichart.com/documentation/js/v4/typedoc/classes/axisbase2d.html)**. 
...
classDiagram
    ...
    IndexAxis <|-- DiscontinuousDateAxis
```
...
The properties common to the **AxisBase2D** / **AxisCore** classes can be found in the [TypeDoc API documentation:blue_book:](https://www.scichart.com/documentation/js/v4/typedoc/classes/axisbase2d.html).
...
| **[IndexAxis](/2d-charts/axis-api/axis-types/index-axis/)** | The IndexAxis is an axis type that combines the benefits of both CategoryAxis and DateTimeNumericAxis. This hybrid axis type uses X-Index positioning like CategoryAxis while maintaining the ability to display DateTime values as labels, making it ideal for financial and time-series data with irregular intervals. |
| **[DiscontinuousDateAxis](http://stagingdemo.scichart.com/documentation/js/v5/typedoc/classes/discontinuousdateaxis.html)** | This axis is designed for use with discontinuous timeseries data, such as weekday only financial data. |
