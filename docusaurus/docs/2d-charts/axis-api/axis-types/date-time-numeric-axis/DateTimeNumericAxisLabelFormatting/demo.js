...
async function labelFormattingWithDateTimeNumericAxis(divElementId) {
    ...
    const { SciChartSurface, DateTimeNumericAxis, SciChartJsNavyTheme, NumberRange, EAxisAlignment, NumericAxis, ZoomPanModifier, MouseWheelZoomModifier, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, ENumericFormat, DateLabelProvider } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { chartBuilder, EThemeProviderType, NumberRange, EAxisAlignment, EAxisType, ENumericFormat, ELabelProviderType, EChart2DModifierType } = SciChart;
