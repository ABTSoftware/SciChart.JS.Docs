...
export async function polarAxisDemo(rootElement) {
    // #region_A_start
    const { SciChartPolarSurface, SciChartJsNavyTheme, PolarNumericAxis, PolarLineRenderableSeries, XyDataSeries, EPolarAxisMode, NumberRange, EAxisAlignment, EPolarLabelMode } = SciChart;
