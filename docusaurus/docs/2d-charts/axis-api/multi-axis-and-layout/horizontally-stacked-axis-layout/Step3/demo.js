...
async function horizontallyStackedAxis(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, EAxisAlignment, TopAlignedOuterHorizontallyStackedAxisLayoutStrategy, FastLineRenderableSeries, XyDataSeries } = SciChart;
    ...
    sciChartSurface.yAxes.add(new NumericAxis(wasmContext, { axisTitle: "Rotated, Stacked Y Axis 0", axisAlignment }));
    sciChartSurface.yAxes.add(new NumericAxis(wasmContext, { axisTitle: "Rotated, Stacked Y Axis 1", axisAlignment }));
    sciChartSurface.yAxes.add(new NumericAxis(wasmContext, { axisTitle: "Rotated, Stacked Y Axis 2", axisAlignment }));
    sciChartSurface.yAxes.add(new NumericAxis(wasmContext, { axisTitle: "Rotated, Stacked Y Axis 3", axisAlignment }));
    // #region_A_end
