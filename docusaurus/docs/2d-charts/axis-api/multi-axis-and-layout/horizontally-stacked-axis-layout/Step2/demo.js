...
async function horizontallyStackedAxis(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, EAxisAlignment, FastLineRenderableSeries, XyDataSeries, BottomAlignedOuterHorizontallyStackedAxisLayoutStrategy, NumberRange } = SciChart;
