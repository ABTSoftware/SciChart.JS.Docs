...
async function centralAxisConfigure(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, CentralAxesLayoutManager, EInnerAxisPlacementCoordinateMode } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { chartBuilder, EThemeProviderType, EAxisType, ELayoutManagerType, EInnerAxisPlacementCoordinateMode } = SciChart;
