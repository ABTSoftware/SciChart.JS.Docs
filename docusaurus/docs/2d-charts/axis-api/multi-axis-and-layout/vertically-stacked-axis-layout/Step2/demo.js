...
async function verticallyStackedAxis(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, EAxisAlignment, FastLineRenderableSeries, XyDataSeries, LeftAlignedOuterVerticallyStackedAxisLayoutStrategy } = SciChart;
