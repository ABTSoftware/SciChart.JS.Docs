...
async function polarChartLayout(divElementId) {
    // #region_A_start
    const { SciChartPolarSurface, PolarNumericAxis, NumberRange, SciChartJsNavyTheme, EPolarAxisMode, } = SciChart;
    ...
    // #region_A_end
    sciChartSurface.renderableSeries.add(new SciChart.PolarLineRenderableSeries(wasmContext, {
