...
To create an Inner axis simply set [isInnerAxis: true:blue_book:](https://www.scichart.com/documentation/js/v4/typedoc/classes/numericaxis.html#isinneraxis) on the axis options:
