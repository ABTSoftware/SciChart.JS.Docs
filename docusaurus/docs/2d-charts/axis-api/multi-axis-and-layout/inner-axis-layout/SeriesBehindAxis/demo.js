...
async function seriesBehindAxis(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, BoxAnnotation, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, FastLineRenderableSeries, XyDataSeries } = SciChart;
