...
async function labelAlignment(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, LogarithmicAxis, SciChartJsNavyTheme, EAxisAlignment, ELabelAlignment, NumberRange, ENumericFormat } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { chartBuilder, EThemeProviderType, EAxisAlignment, ELabelAlignment, EAxisType, ENumericFormat, NumberRange } = SciChart;
