...
async function labelproviderProperties(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, ENumericFormat, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EAxisAlignment, NumberRange, LogarithmicAxis, ZoomPanModifier, MouseWheelZoomModifier, Thickness } = SciChart;
...
async function builderExample(divElementId) {
    const { chartBuilder, EThemeProviderType, ENumericFormat, EAxisType, EAxisAlignment, Thickness, NumberRange } = SciChart;
