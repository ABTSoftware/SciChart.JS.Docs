...
async function labelproviderProperties(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, ENumericFormat, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint } = SciChart;
    ...
    addChartTitle(sciChartSurface, "LabelProvider properties example", "Shows how to set labelProvider properties on axis");
    // #region_A_start
...
async function builderExample(divElementId) {
    const { build2DChart, EThemeProviderType, ENumericFormat, EAxisType } = SciChart;
    // #region_B_start
