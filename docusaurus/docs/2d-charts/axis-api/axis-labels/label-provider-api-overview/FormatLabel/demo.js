...
async function labelProviderFormatLabel(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, NumberRange, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint } = SciChart;
    ...
    addChartTitle(sciChartSurface, "LabelProvider.formatLabel() example", "Override formatLabel() and return hexadecimal");
...
async function builderExample(divElementId) {
    const { build2DChart, EThemeProviderType, NumberRange, EAxisType } = SciChart;
    // #region_B_start
