...
:::tip
For an example of using rotation with text labels see the [Multiline and Rotated Text Labels](https://www.scichart.com/demo/javascript-multiline-labels) demo in our examples suite.
:::
