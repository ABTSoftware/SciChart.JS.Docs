...
async function labelProviderClass(divElementId) {
    const { SciChartSurface, NumericAxis, LogarithmicAxis, SciChartJsNavyTheme, NumberRange, TextAnnotation, ENumericFormat, ECoordinateMode, EHorizontalAnchorPoint, ZoomPanModifier, MouseWheelZoomModifier } = SciChart;
...
async function builderExample(divElementId) {
    const { build2DChart, ENumericFormat, EThemeProviderType, NumberRange, EAxisType, EChart2DModifierType } = SciChart;
    // #region_C_start
