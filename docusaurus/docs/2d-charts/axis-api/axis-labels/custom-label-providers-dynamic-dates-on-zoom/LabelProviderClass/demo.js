...
async function labelProviderClass(divElementId) {
    const { SciChartSurface, DateTimeNumericAxis, NumericAxis, SciChartJsNavyTheme, NumberRange, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, ZoomPanModifier, MouseWheelZoomModifier } = SciChart;
