...
async function polarAxisStyling(divElementId) {
    // #region_A_start
    const { SciChartPolarSurface, PolarNumericAxis, NumberRange, SciChartJsNavyTheme, EPolarAxisMode, EPolarGridlineMode, PolarCategoryAxis, EPolarLabelMode } = SciChart;
    ...
    sciChartSurface.xAxes.add(new PolarCategoryAxis(wasmContext, {
