...
async function cursorDataTemplates(divElementId) {
    const { SciChartSurface, NumericAxis, FastLineRenderableSeries, XyDataSeries, SciChartJsNavyTheme, CursorModifier, TextAnnotation, EHorizontalAnchorPoint, ECoordinateMode, EllipsePointMarker } = SciChart;
        ...
        tooltipDataTemplate: (seriesInfos, tooltipTitle) => {
            ...
            seriesInfos.forEach(si => {
                ...
                if (si.isHit) {
                    ...
                    lineItems.push(`Y-value from dataSeries: ${si.renderableSeries.dataSeries
                        .getNativeYValues()
...
async function builderExample(divElementId) {
    ...
    const { build2DChart, EThemeProviderType, EAxisType, EChart2DModifierType } = SciChart;
