...
async function cursorModifierActiveLegendsOnCandles(divElementId) {
    ...
    sciChartSurface.renderableSeries.add(
        new FastLineRenderableSeries(wasmContext, {
            dataSeries: new XyMovingAverageFilter(candlestickSeries.dataSeries as BaseDataSeries, {
    ...
    sciChartSurface.chartModifiers.add(
        new MouseWheelZoomModifier({ excludedYAxisIds: ["VolumeAxisId"] }),
        new ZoomPanModifier({ excludedYAxisIds: ["VolumeAxisId"] }),
