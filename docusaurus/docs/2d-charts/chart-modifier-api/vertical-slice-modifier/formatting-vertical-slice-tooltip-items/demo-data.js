...
async function formattingVerticalSliceModifier(divElementId) {
    const { SciChartSurface, NumericAxis, FastLineRenderableSeries, XyDataSeries, SciChartJsNavyTheme, NumberRange, VerticalSliceModifier, TextAnnotation, EHorizontalAnchorPoint, ECoordinateMode, EllipsePointMarker, ZoomPanModifier, ZoomExtentsModifier, MouseWheelZoomModifier } = SciChart;
    ...
    const tooltipDataTemplate = (seriesInfo, tooltipTitle, tooltipLabelX, tooltipLabelY) => {
        ...
        const lineItems = [];
        // See SeriesInfo docs at https://www.scichart.com/documentation/js/v5/typedoc/classes/xyseriesinfo.html
        ...
        lineItems.push(`Y-value from dataSeries: ${seriesInfo.renderableSeries.dataSeries
            .getNativeYValues()
