...
async function basicSeriesSelection(divElementId) {
    // #region_A_start
    const { SciChartSurface, NumericAxis, FastLineRenderableSeries, XyDataSeries, SciChartJsNavyTheme, NumberRange, SeriesSelectionModifier, TextAnnotation, EHorizontalAnchorPoint, ECoordinateMode, EllipsePointMarker } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { build2DChart, ESeriesType, EThemeProviderType, EPointMarkerType, EChart2DModifierType } = SciChart;
