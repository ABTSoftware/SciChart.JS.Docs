import { SciChartSurface, NumericAxis, EAxisAlignment, FastLineRenderableSeries, XyDataSeries, LegendModifier } from "scichart";
...
export async function customModifiersSandboxTs(divId) {
