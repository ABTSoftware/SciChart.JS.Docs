...
export async function PolarZoomExtents(divElementId) {
    const { SciChartPolarSurface, PolarNumericAxis, EPolarAxisMode, XyDataSeries, SciChartJsNavyTheme, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, PolarColumnRenderableSeries, PolarPanModifier, PolarMouseWheelZoomModifier, EAxisAlignment } = SciChart;
    ...
    new PolarPanModifier(), new PolarMouseWheelZoomModifier());
}
...
async function builderExample(divElementId) {
    ...
    const { build2DPolarChart, EAxisAlignment, EThemeProviderType, EAxisType, EChart2DModifierType, EPolarAxisMode, Point, ESeriesType } = SciChart;
