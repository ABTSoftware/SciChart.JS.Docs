...
async function builderExample(divElementId) {
    ...
    const { build2DChart, build2DPolarChart, EThemeProviderType, EAxisType, EChart2DModifierType, ESeriesType, EPolarAxisMode, DataPointSelectionPaletteProvider } = SciChart;
