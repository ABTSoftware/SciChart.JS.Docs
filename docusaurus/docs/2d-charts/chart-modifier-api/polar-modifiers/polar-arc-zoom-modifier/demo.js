...
export async function PolarArcZoom(divElementId) {
    const { SciChartPolarSurface, PolarNumericAxis, XyDataSeries, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, PolarLineRenderableSeries, PolarZoomExtentsModifier, SciChartJsNavyTheme, EPolarAxisMode, NumberRange } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { build2DChart, build2DPolarChart, EThemeProviderType, EAxisType, EChart2DModifierType, easing, EPolarAxisMode, ESeriesType } = SciChart;
