...
async function PolarCursorModifier(divElementId) {
    const { SciChartPolarSurface, PolarNumericAxis, EPolarAxisMode, XyDataSeries, SciChartJsNavyTheme, NumberRange, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, PolarColumnRenderableSeries } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { build2DChart, build2DPolarChart, EAxisType, EChart2DModifierType, EPolarAxisMode, EAngularAxisLabelPlacement, ERadialAxisLabelPlacement, ESeriesType } = SciChart;
