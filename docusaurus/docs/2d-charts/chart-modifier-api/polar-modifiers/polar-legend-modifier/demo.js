...
async function PolarLegendModifier(divElementId) {
    const { SciChartPolarSurface, EPolarAxisMode, PolarNumericAxis, XyDataSeries, SciChartJsNavyTheme, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, PolarColumnRenderableSeries, PolarLineRenderableSeries } = SciChart;
