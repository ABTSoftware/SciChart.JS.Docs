...
export async function PolarPanModifier(divElementId) {
    const { SciChartPolarSurface, PolarNumericAxis, XyDataSeries, SciChartJsNavyTheme, NumberRange, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint, EVerticalAnchorPoint, PolarZoomExtentsModifier, EPolarAxisMode, PolarMountainRenderableSeries } = SciChart;
    ...
    sciChartSurface.renderableSeries.add(new PolarMountainRenderableSeries(wasmContext, {
        stroke: "#50C7E0",
        strokeThickness: 5,
...
async function builderExample(divElementId) {
    ...
    const { build2DPolarChart, EThemeProviderType, EAxisType, EChart2DModifierType, EActionType, EPolarAxisMode } = SciChart;
