...
async function builderExample(divElementId) {
    ...
    const { build2DChart, ESeriesType, EAxisType, EThemeProviderType, Rect, ESubSurfacePositionCoordinateMode, EAxisAlignment, NumberRange, EChart2DModifierType } = SciChart;
