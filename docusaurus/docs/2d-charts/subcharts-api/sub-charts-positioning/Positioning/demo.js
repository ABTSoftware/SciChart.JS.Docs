...
async function simpleSubChart(divElementId) {
    ...
    const { SciChartSurface, SciChartSubSurface, NumericAxis, FastLineRenderableSeries, XyDataSeries, SciChartJsNavyTheme, Rect, ECoordinateMode, ZoomPanModifier, ZoomExtentsModifier, MouseWheelZoomModifier, EXyDirection, NumberRange } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { chartBuilder, ESeriesType, EAxisType, EThemeProviderType, Rect, ECoordinateMode, EAnnotationType, NumberRange, EChart2DModifierType } = SciChart;
