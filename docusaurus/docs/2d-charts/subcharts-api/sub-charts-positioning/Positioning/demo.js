...
async function simpleSubChart(divElementId) {
    ...
    const { SciChartSurface, SciChartSubSurface, NumericAxis, FastLineRenderableSeries, XyDataSeries, SciChartJsNavyTheme, Rect, ECoordinateMode, ESubSurfacePositionCoordinateMode, ZoomPanModifier, ZoomExtentsModifier, MouseWheelZoomModifier, EXyDirection, NumberRange } = SciChart;
    ...
    sciChartSurface.annotations.add(new TextAnnotation({
        x1: 0.5,
        y1: 0.5,
        text: "Drag Zoom horizontally to update the SubChart position",
...
async function builderExample(divElementId) {
    ...
    const { chartBuilder, ESeriesType, EAxisType, EThemeProviderType, Rect, ESubSurfacePositionCoordinateMode, NumberRange, EChart2DModifierType } = SciChart;
