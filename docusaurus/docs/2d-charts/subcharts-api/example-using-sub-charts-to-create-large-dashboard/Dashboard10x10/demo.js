...
// #region_helperFunctions_end
// #region_ExampleA_start
...
async function create10x10PanelChart(divElementId) {
    ...
    for (let subChartIndex = 0; subChartIndex < subChartsNumber; ++subChartIndex) {
        ...
        subSurface.xAxes.add(new NumericAxis(wasmContext, {
            isVisible: false,
            autoRange: EAutoRange.Always
        }));
        subSurface.yAxes.add(new NumericAxis(wasmContext, { isVisible: false }));
        // Add random data series
        subSurface.renderableSeries.add(new FastLineRenderableSeries(wasmContext, {
        ...
        subSurface.annotations.add(new TextAnnotation({
            x1: 0,
            y1: 0,
...
// #region_dataUpdates_end
// #region_ExampleC_start
