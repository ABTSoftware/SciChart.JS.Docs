...
import { NumericAxis, ZoomPanModifier, ZoomExtentsModifier, MouseWheelZoomModifier, SciChartSurface, ENumericFormat, FastRectangleRenderableSeries, XyxyDataSeries, EColumnYMode, EColumnMode, EDataPointWidthMode, NumberRange, EHorizontalTextPosition, EVerticalTextPosition, Thickness } from "scichart";
...
export const drawExample = async (rootElement) => {
    ...
    console.log("Dpi", SciChart.DpiHelper.PIXEL_RATIO);
    // Adjust the size of the custom texture so it scales as you zoom
    sciChartSurface.layoutMeasured.subscribe(args => {
        ...
        sciChartSurface.resumeUpdates({ invalidateOnResume: false });
        // }
    });
