import { SciChartSurface, NumericAxis, EAutoRange, NumberRange, ZoomPanModifier, Point, DpiHelper, Rect, MouseWheelZoomModifier } from "scichart";

export const drawExampleCustomCanvas2dImage = async (rootElement: string | HTMLDivElement) => {
...
// #region_B_start
function drawBasic2DScene(ctx: CanvasRenderingContext2D): void {
...
function drawCircleClippedToRect(
