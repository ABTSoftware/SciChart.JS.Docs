import { SciChartSurface, EAutoRange, FastLineRenderableSeries, NumberRange, XyDataSeries, NumericAxis } from "scichart";
...
drawExample("scichart-root").then(initResult => {
    const button = document.getElementById("toggleDataUpdatesButton");
