...
## Using [buildChart:blue_book:](https://www.scichart.com/documentation/js/v5/typedoc/index.html#chartbuilder.buildchart) to create a Pie Chart
...
## Using [buildPieChart:blue_book:](https://www.scichart.com/documentation/js/v5/typedoc/index.html#buildpiechart) to explicitly create a Pie Chart:
