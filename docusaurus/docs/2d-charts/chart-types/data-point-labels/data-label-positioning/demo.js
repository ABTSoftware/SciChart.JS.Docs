...
async function dataLabelSkipModes(divElementId) {
    const { SciChartSurface, NumericAxis, EllipsePointMarker, XyDataSeries, NumberRange, SciChartJsNavyTheme } = SciChart;
    ...
    // #region_A_start
    const { FastLineRenderableSeries, ELineType, EDataLabelSkipMode, EVerticalTextPosition, EHorizontalTextPosition, Thickness } = SciChart;
