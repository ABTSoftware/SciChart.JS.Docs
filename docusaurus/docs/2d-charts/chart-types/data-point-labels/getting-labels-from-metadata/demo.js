...
export async function dataLabelsMetadata(divElementId) {
    // #region_A_start
    const { SciChartSurface, NumericAxis, FastLineRenderableSeries, EllipsePointMarker, XyDataSeries, NumberRange, SciChartJsNavyTheme } = SciChart;
