...
export async function dataLabelColoring(divElementId) {
    const { SciChartSurface, NumericAxis, FastColumnRenderableSeries, XyDataSeries, NumberRange, EColumnDataLabelPosition, parseColorToUIntArgb, Thickness, SciChartJsNavyTheme } = SciChart;
