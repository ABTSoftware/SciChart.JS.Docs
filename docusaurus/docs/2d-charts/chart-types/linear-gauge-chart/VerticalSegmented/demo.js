...
async function verticalSegmentedGauge(divElementId) {
    const { SciChartSurface, NumericAxis, SciChartJsNavyTheme, NumberRange, FastRectangleRenderableSeries, XyxyDataSeries,
        EColumnMode, EColumnYMode, EFillPaletteMode, parseColorToUIntArgb, LineArrowAnnotation, EArrowHeadPosition,
        TextAnnotation, EHorizontalAnchorPoint, EVerticalAnchorPoint } = SciChart;
