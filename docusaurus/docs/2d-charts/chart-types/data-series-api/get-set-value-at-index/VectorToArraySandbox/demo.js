...
const { SciChartSurface, XyDataSeries, NumericAxis, TextAnnotation, vectorToArray, vectorToArrayViewF64, SciChartDefaults, libraryVersion } = SciChart;
async function initSciChart() {
    ...
    const example5 = () => {
        ...
        const f64XValues = vectorToArrayViewF64(dataSeries.getNativeXValues(), wasmContext);
        const f64YValues = vectorToArrayViewF64(dataSeries.getNativeYValues(), wasmContext);
    ...
    const example6 = () => {
        ...
        const jsXValues = vectorToArray(dataSeries.getNativeXValues(), wasmContext);
        const jsYValues = vectorToArray(dataSeries.getNativeYValues(), wasmContext);
    ...
    const example7 = () => {
        ...
        seriesDest.appendRange(vectorToArrayViewF64(seriesSrc.getNativeXValues(), wasmContext), vectorToArrayViewF64(seriesSrc.getNativeYValues(), wasmContext));
