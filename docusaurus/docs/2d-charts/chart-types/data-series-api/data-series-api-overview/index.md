...
Examples can be found in the [SciChart.js examples suite](https://demo.scichart.com), or in our documentation on the [Label Formatting page](/2d-charts/axis-api/axis-labels/numeric-formats).
