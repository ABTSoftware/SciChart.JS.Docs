...
async function dataSeriesScrollingFifo(divElementId) {
    const { SciChartSurface, NumericAxis, FastLineRenderableSeries, XyDataSeries, SciChartJsNavyTheme, EAutoRange, CategoryAxis, libraryVersion, EllipsePointMarker } = SciChart;
