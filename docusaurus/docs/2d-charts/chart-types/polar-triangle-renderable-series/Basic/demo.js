...
export async function PolarTriangleChart(divElementId) {
    ...
    const { SciChartPolarSurface, PolarNumericAxis, PolarTriangleRenderableSeries, EPolarAxisMode, XyDataSeries, EFillPaletteMode, parseColorToUIntArgb, SciChartJsNavyTheme, ETriangleSeriesDrawMode, NumberRange } = SciChart;
