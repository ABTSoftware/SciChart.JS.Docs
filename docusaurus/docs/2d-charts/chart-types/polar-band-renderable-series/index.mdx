...
```ts showLineNumbers {10-18} file=./GradientFill/demo.ts start=region_A_start end=region_A_end
```
...
```ts showLineNumbers {9-15,17-24,36} file=./PaletteProvider/demo.ts start=region_A_start end=region_A_end
```
