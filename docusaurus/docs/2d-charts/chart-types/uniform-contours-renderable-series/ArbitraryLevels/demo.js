...
function createSeries(heatmapWidth, heatmapHeight, colorPaletteMin, colorPaletteMax) {
...
const drawArbitraryLevels = async (divElementId) => {
    ...
    const initialZValues = createSeries(heatmapWidth, heatmapHeight, colorPaletteMin, colorPaletteMax);
    ...
    sciChartSurface.chartModifiers.add(new CursorModifier({ showTooltip: true, includedSeriesIds: [contourSeries.id] }));
