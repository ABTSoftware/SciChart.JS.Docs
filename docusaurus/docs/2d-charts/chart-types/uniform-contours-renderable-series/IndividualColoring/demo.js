...
async function individuallyColoredContours(divElementId) {
    // #region_A_start
    // Demonstrates how to colour each contour line by its own z-value
    const { SciChartSurface, NumericAxis, HeatmapColorMap, UniformHeatmapDataSeries, UniformContoursRenderableSeries, EContourColorMapMode, SciChartJsNavyTheme } = SciChart;
