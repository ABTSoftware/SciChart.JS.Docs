...
const { SciChartSurface, FastLineRenderableSeries, NumericAxis, XyDataSeries, makeIncArray, PaletteFactory, GradientParams, NumberRange, Point, SciChartJsNavyTheme, EllipsePointMarker, MouseWheelZoomModifier, ZoomPanModifier, ZoomExtentsModifier } = SciChart;
async function lineChartWithGradient(divElementId) {
    ...
    // #region_A_start
    const gradientPalette = PaletteFactory.createGradient(wasmContext, new GradientParams(new Point(0, 0), new Point(1, 1), [
        { color: "red", offset: 0 },
