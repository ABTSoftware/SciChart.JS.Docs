...
const { SciChartSurface, FastLineRenderableSeries, NumericAxis, XyDataSeries, makeIncArray, PaletteFactory, GradientParams, NumberRange, Point, EllipsePointMarker, SciChartJsNavyTheme, MouseWheelZoomModifier, ZoomPanModifier, ZoomExtentsModifier } = SciChart;
async function lineChartWithyGradient(divElementId) {
    ...
    // #region_A_start
    const yGradientPalette = PaletteFactory.createYGradient(wasmContext, new GradientParams(new Point(0, 0), new Point(0, 1), [
