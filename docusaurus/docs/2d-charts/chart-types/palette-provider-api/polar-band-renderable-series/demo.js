...
async function paletteProviderBandChart(divElementId) {
    ...
    const { SciChartPolarSurface, PolarNumericAxis, PolarBandRenderableSeries, EPolarAxisMode, EAxisAlignment, EPolarLabelMode, XyyDataSeries, SciChartJsNavyTheme } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { EThemeProviderType, build2DPolarChart, EPolarAxisMode, EAxisAlignment, EPolarLabelMode, EAxisType, ESeriesType, } = SciChart;
