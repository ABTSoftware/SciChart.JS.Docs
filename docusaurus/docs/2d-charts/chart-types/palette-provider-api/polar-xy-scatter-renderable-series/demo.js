...
async function drawScatterChartWithPalette(divElementId) {
    ...
    const { SciChartPolarSurface, PolarNumericAxis, PolarXyScatterRenderableSeries, XyDataSeries, EllipsePointMarker, SciChartJsNavyTheme, HorizontalLineAnnotation, EPolarAxisMode, EAxisAlignment, NumberRange, ELabelPlacement } = SciChart;
