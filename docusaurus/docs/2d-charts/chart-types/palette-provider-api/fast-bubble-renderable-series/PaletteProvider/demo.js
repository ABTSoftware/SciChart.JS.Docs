...
async function drawBubbleChartWithPalette(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, XyzDataSeries, FastBubbleRenderableSeries, EllipsePointMarker, SciChartJsNavyTheme, ELabelPlacement, HorizontalLineAnnotation } = SciChart;
