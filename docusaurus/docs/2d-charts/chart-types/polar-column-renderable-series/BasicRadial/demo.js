...
export async function polarRadialColumnChart(divElementId) {
    ...
    const { SciChartPolarSurface, SciChartJsNavyTheme, PolarNumericAxis, PolarColumnRenderableSeries, EPolarAxisMode, EAxisAlignment, EPolarLabelMode, NumberRange, XyDataSeries, EColumnDataLabelPosition } = SciChart;
