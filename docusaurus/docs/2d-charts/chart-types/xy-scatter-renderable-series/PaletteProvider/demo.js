...
async function drawScatterChartWithPalette(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, XyScatterRenderableSeries, XyDataSeries, EllipsePointMarker, SciChartJsNavyTheme, HorizontalLineAnnotation, ELabelPlacement } = SciChart;
