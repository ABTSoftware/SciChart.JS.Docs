...
The IHitTestProvider.hitTest method on [PolarColumnRenderableSeries](https://www.scichart.com/documentation/js/current/PolarColumnRenderableSeries.html) tests if the click was within the Column's body and returns a [HitTestInfo](https://www.scichart.com/documentation/js/v4/typedoc/classes/hittestinfo.html) object with the following properties:
...
2. Test if the click was within column body and update [HitTestInfo.isHit](https://www.scichart.com/documentation/js/v4/typedoc/classes/hittestinfo.html#isHit) property.
