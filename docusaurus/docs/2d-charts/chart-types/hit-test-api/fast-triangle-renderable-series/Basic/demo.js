import { NumberRange, SciChartSurface, NumericAxis, SciChartJsNavyTheme, CustomAnnotation, EHorizontalAnchorPoint, EVerticalAnchorPoint, ECoordinateMode, NativeTextAnnotation, EMultiLineAlignment, DpiHelper, XyDataSeries, FastTriangleRenderableSeries, ETriangleSeriesDrawMode, EFillPaletteMode, parseColorToUIntArgb } from "scichart";
class SPaletteProvider {
    // Why does the solid mode draw a gradient?
    fillPaletteMode = EFillPaletteMode.SOLID;
    palettedRed = parseColorToUIntArgb("salmon");
    palettedGreen = parseColorToUIntArgb("skyblue");
