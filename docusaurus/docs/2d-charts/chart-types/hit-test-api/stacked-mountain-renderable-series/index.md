...
 The [StackedMountainCollection](/2d-charts/chart-types/stacked-mountain-renderable-series) in this example has three [StackedMountainRenderableSeries](/2d-charts/chart-types/stacked-mountain-renderable-series). Therefore, we use **reduce** function to iterate over each renderable series and to accumulate the result.
