...
export async function serialisedPointMarker(rootElement) {
    ...
    const { SciChartPolarSurface, SciChartJsNavyTheme, XyDataSeries, PolarNumericAxis, EPolarAxisMode, NumberRange, EAxisAlignment, EPolarLabelMode, PolarXyScatterRenderableSeries, EPointMarkerType, RadianLabelProvider } = SciChart;
...
if (location.search.includes("builder=1"))
    builderPointMarker("scichart-root");
