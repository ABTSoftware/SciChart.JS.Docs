...
export async function simpleScatterChart(rootElement) {
    ...
    const { SciChartPolarSurface, SciChartJsNavyTheme, XyDataSeries, PolarNumericAxis, EPolarAxisMode, NumberRange, EAxisAlignment, EPolarLabelMode, PolarXyScatterRenderableSeries, TrianglePointMarker, } = SciChart;
...
if (location.search.includes("builder=1"))
    builderScatterChart("scichart-root");
