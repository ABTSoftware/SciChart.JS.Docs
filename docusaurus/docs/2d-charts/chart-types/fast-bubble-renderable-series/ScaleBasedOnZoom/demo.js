...
async function scaleBasedOnZoom(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, XyzDataSeries, FastBubbleRenderableSeries, EllipsePointMarker, SciChartJsNavyTheme } = SciChart;
    ...
    const adjustSeriesStyle = () => {
        ...
        const size = (Math.round(sciChartSurface.seriesViewRect.width) * zoomMultiplier) / bubbleSeries.dataSeries.count();
