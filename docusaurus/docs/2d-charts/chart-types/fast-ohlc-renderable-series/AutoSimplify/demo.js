import { SciChartSurface, SciChartJsNavyTheme, NumericAxis, NumberRange, OhlcDataSeries, FastOhlcRenderableSeries, MouseWheelZoomModifier, ZoomPanModifier, ZoomExtentsModifier, EXyDirection, TextAnnotation, ECoordinateMode, EHorizontalAnchorPoint } from "scichart";
async function ohlcAutoSimplify(divElementId) {
    ...
    sciChartSurface.chartModifiers.add(new MouseWheelZoomModifier({ xyDirection: EXyDirection.XDirection, growFactor: 0.0005 }), new ZoomPanModifier({ xyDirection: EXyDirection.XDirection }), new ZoomExtentsModifier());
}
