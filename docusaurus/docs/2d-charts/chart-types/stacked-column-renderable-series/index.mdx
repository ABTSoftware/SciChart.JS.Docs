...
```js showLineNumbers file=./basic-example/demo.js start=region_A_start end=region_A_end
...
```js showLineNumbers file=./grouping-options/stackedExample.js start=region_A_start end=region_A_end
...
```js showLineNumbers file=./grouping-options/groupedExample.js start=region_A_start end=region_A_end
...
```js showLineNumbers file=./grouping-options/mixedExample.js start=region_A_start end=region_A_end
...
```js showLineNumbers file=./grouping-options/100PercentExample.js start=region_A_start end=region_A_end
...
```js showLineNumbers file=./gradient-fill-example/demo.js start=region_A_start end=region_A_end
