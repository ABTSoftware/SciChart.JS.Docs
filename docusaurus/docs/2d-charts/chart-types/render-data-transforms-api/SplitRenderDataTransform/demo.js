import { ColumnSeriesDrawingProvider, DataPointSelectionModifier, ECoordinateMode, EHorizontalAnchorPoint, ELineDrawMode, EllipsePointMarker, EVerticalAnchorPoint, FastColumnRenderableSeries, FastLineRenderableSeries, GradientParams, LineSeriesDrawingProvider, NativeTextAnnotation, NumberRange, NumericAxis, OhlcPointSeriesResampled, Point, PointMarkerDrawingProvider, RolloverModifier, SciChartJsNavyTheme, SciChartSurface, TrianglePointMarker, vectorToArrayViewF64, XyDataSeries, BaseRenderDataTransform } from "scichart";
// #region_A_start
/**
...
// #region_A_end
async function splitRenderDataTransform(divElementId) {
    ...
    const selectedColDP = new ColumnSeriesDrawingProvider(wasmContext, columnSeries, 
    ...
    columnSeries.renderDataTransform = new SplitRenderDataTransform(columnSeries, wasmContext, columnSeries.drawingProviders);
    ...
    sciChartSurface.chartModifiers.add(new RolloverModifier({
        tooltipDataTemplate: (seriesInfo) => {
            ...
            vals.push(`selected ${seriesInfo.pointMetadata.isSelected}`);
            return vals;
        }
    }));
