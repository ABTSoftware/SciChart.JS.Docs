...
async function basicTriangleSeriesChart(divElementId) {
    ...
    // Polygon
    dataSeries.append(200, 200);
    dataSeries.append(100, 100);
    dataSeries.append(100, 300);
    dataSeries.append(300, 300);
    dataSeries.append(300, 100);
    dataSeries.append(100, 100);

    dataSeries.append(500, 300);
    dataSeries.append(600, 500);
    dataSeries.append(700, 550);
    dataSeries.append(800, 500);
    dataSeries.append(900, 300);
    dataSeries.append(700, 200);
