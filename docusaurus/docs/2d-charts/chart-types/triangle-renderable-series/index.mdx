...
```js {22} showLineNumbers file=./triangle-series-polygon/demo.js start=region_A_start end=region_A_end
...
```js {20} showLineNumbers file=./triangle-series-strip/demo.js start=region_A_start end=region_A_end
...
<ChartPreviewWrapper maxWidth={600} jsContent={triangleSeriesTexture} />