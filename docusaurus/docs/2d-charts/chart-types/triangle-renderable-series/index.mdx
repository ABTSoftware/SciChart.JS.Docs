...
import triangleSeriesTexture from "!!raw-loader!./triangle-series-texture/demo";
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={triangleSeriesList} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={triangleSeriesPolygon} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={triangleSeriesStrip} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={triangleSeriesCustomGradient} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={triangleSeriesTexture} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={australiaMap} />
