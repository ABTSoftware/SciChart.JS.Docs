import { SciChartSurface, NumericAxis, SciChartJsNavyTheme, FastTriangleRenderableSeries, XyDataSeries, ETriangleSeriesDrawMode, ZoomPanModifier, ZoomExtentsModifier, NumberRange } from "scichart";
...
async function australiaMap(divElementId) {
    ...
    const triangleSeriesAustralia = new FastTriangleRenderableSeries(wasmContext, {
    ...
    const triangleSeriesTasmania = new FastTriangleRenderableSeries(wasmContext, {
