...
async function simpleColumnChart(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, FastColumnRenderableSeries, XyDataSeries, SciChartJsNavyTheme, EDataPointWidthMode, RightAlignedOuterVerticallyStackedAxisLayoutStrategy, NumberRange, EXyDirection, MouseWheelZoomModifier, ZoomExtentsModifier } = SciChart;
    ...
    sciChartSurface.chartModifiers.add(new MouseWheelZoomModifier({ xyDirection: EXyDirection.XDirection }), new ZoomExtentsModifier());
}
