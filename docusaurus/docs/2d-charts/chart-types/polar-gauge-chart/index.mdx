...
```ts showLineNumbers {16-35} file=./UsingColumn/demo.ts start=region_A_start end=region_A_end
```
...
```ts showLineNumbers {8-18,33-42,66,80} file=./ComplexArc/demo.ts start=region_A_start end=region_A_end
```
