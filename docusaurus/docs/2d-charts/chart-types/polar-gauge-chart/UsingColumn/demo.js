...
async function drawGaugeChartColumn(divElementId) {
    ...
    const { SciChartPolarSurface, SciChartJsNavyTheme, NumberRange, Thickness, PolarNumericAxis, EPolarAxisMode, PolarColumnRenderableSeries, XyxyDataSeries, EColumnMode, GradientParams, Point } = SciChart;
