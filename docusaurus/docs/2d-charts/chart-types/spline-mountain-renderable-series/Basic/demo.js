...
async function simpleSplineMountainChart(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, SplineMountainRenderableSeries, EllipsePointMarker, XyDataSeries, SciChartJsNavyTheme, NumberRange, GradientParams, Point } = SciChart;
