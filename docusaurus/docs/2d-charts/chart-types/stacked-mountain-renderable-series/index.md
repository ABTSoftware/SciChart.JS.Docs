...
The [](https://demo.scichart.com/javascript-stacked-mountain-chart)[](https://demo.scichart.com/javascript-stacked-mountain-chart)[JavaScript Stacked Mountain Chart Example](https://demo.scichart.com/javascript-stacked-mountain-chart) can be found in the [SciChart.Js Examples Suite](https://github.com/abtsoftware/scichart.js.examples) on Github, or our live demo at [demo.scichart.com](https://demo.scichart.com/)

_**Above**: The [JavaScript Stacked Mountain Chart example](https://demo.scichart.com/javascript-stacked-mountain-chart) from the SciChart.js Demo._
            ...
            series: \[
                {
                    ...
                    options: { fill: "#882B91", stroke: "#E4F5FC" },
                    xyData: { xValues, yValues: yValues1 }
                },
                {
                    type: ESeriesType.StackedMountainSeries,
                    options: { fill: "#EC0F6C", stroke: "#E4F5FC" },
                    xyData: { xValues, yValues: yValues2 }
                },
                {
                    type: ESeriesType.StackedMountainSeries,
                    options: { fill: "#F48420", stroke: "#E4F5FC" },
                    xyData: { xValues, yValues: yValues3 }
                },
                {
                    type: ESeriesType.StackedMountainSeries,
                    options: { fill: "#50C7E0", stroke: "#E4F5FC" },
                    xyData: { xValues, yValues: yValues4 }
                },
                {
                    type: ESeriesType.StackedMountainSeries,
                    options: { fill: "#30BC9A", stroke: "#E4F5FC" },
