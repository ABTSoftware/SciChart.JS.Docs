...
<ChartPreviewWrapper jsContent={basicDemo} />
```ts {13,14} showLineNumbers file=./basic/demo.ts start=region_A_start end=region_A_end
...
<ChartPreviewWrapper jsContent={customTextureSupport} />
...
<ChartPreviewWrapper jsContent={customLabel} />
...
<ChartPreviewWrapper jsContent={animated} />
