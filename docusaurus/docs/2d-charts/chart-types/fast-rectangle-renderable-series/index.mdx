...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={basicDemo} />
```ts {13,14} showLineNumbers file=./basic/demo.ts start=region_A_start end=region_A_end
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={customTextureSupport} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={customLabel} />
...
<ChartPreviewWrapper maxWidth={"100%"} jsContent={animated} />
