...
import basicDemo from "!!raw-loader!./basic/demo";
import customTextureSupport from "!!raw-loader!./custom-texture-support/demo";
import customLabel from "!!raw-loader!./custom-label/demo";
import animated from "!!raw-loader!./animated/demo";
...
```ts {14,15} showLineNumbers file=./basic/demo.ts start=region_A_start end=region_A_end
...
<ChartPreviewWrapper maxWidth={600} jsContent={basicDemo} />
```ts {(14, 15)} showLineNumbers file=./basic/demo.ts start=region_A_start end=region_A_end

```
### Custom Texture Support

<ChartPreviewWrapper maxWidth={600} jsContent={customTextureSupport} />

### Custom Label

<ChartPreviewWrapper maxWidth={600} jsContent={customLabel} />

### Animated

<ChartPreviewWrapper maxWidth={600} jsContent={animated} />
