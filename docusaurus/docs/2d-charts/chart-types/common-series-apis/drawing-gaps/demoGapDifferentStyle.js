...
async function drawMountainChartsWithGaps(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, FastMountainRenderableSeries, GradientParams, XyDataSeries, Point, SciChartJsNavyTheme, TextAnnotation, LineAnnotation, MouseWheelZoomModifier, ZoomPanModifier, ZoomExtentsModifier, EHorizontalAnchorPoint, EVerticalAnchorPoint } = SciChart;
    ...
    sciChartSurface.annotations.add(new TextAnnotation({
        x1: 75,
        y1: 104.1,
        text: "Render alternate style here",
