...
async function chartTitles(divElementId) {
    ...
    const { SciChartSurface, NumericAxis, SciChartJSLightTheme, Thickness, EMultiLineAlignment, ETextAlignment, ETitlePosition } = SciChart;
...
async function builderExample(divElementId) {
    ...
    const { chartBuilder, EThemeProviderType, EAxisType, Thickness, EMultiLineAlignment, ETextAlignment, ETitlePosition } = SciChart;
