[SciChart.js Documentation - v0.0.6](../README.md) › [Globals](../globals.md) › [PyramidPointMarker3D](pyramidpointmarker3d.md)
...
* [constructor](pyramidpointmarker3d.md#constructor)

### Properties

* [propertyChanged](pyramidpointmarker3d.md#readonly-propertychanged)

### Accessors

* [fill](pyramidpointmarker3d.md#fill)
* [markerType](pyramidpointmarker3d.md#markertype)
* [pointsMesh](pyramidpointmarker3d.md#pointsmesh)
* [size](pyramidpointmarker3d.md#size)

## Constructors

###  constructor

\+ **new PyramidPointMarker3D**(`webAssemblyContext`: TSciChart3D, `options?`: [IBasePointMarker3DOptions](../interfaces/ibasepointmarker3doptions.md)): *[PyramidPointMarker3D](pyramidpointmarker3d.md)*

*Overrides void*

*Defined in [src/Charting3D/Visuals/PointMarkers/DefaultPointMarkers.ts:28](https://github.com/ABTSoftware/SciChart.Dev/blob/ff9f38d289/Web/src/SciChart/src/Charting3D/Visuals/PointMarkers/DefaultPointMarkers.ts#L28)*
...
**Returns:** *[PyramidPointMarker3D](pyramidpointmarker3d.md)*
...
*Defined in [src/Charting3D/Visuals/PointMarkers/DefaultPointMarkers.ts:33](https://github.com/ABTSoftware/SciChart.Dev/blob/ff9f38d289/Web/src/SciChart/src/Charting3D/Visuals/PointMarkers/DefaultPointMarkers.ts#L33)*
